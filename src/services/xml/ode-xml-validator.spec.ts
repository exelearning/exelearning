...
describe('ODE XML Validator', () => {
    describe('validateOdeXml', () => {
        ...
        it('should return valid for exe_document format with proper structure', () => {
            const parsed = {
                exe_document: {
                    meta: { title: 'Test' },
                    navigation: {
        ...
        it('should return error for exe_document with empty navigation', () => {
            const parsed = {
                exe_document: {
                    meta: { title: 'Test' },
                    navigation: {},
        ...
        it('should return error for exe_document with invalid exe_document object', () => {
            const parsed = {
                exe_document: 'not an object',
            };

            const result = validateOdeXml(parsed);
            expect(result.valid).toBe(false);
            expect(result.errors.some(e => e.code === 'INVALID_EXE_DOCUMENT')).toBe(true);
        });

        it('should return error for exe_document with missing meta', () => {
            const parsed = {
                exe_document: {
                    navigation: {
                        page: {
        ...
        it('should return error for exe_document with missing navigation', () => {
            const parsed = {
                exe_document: {
                    meta: { title: 'Test' },
                },
        ...
        it('should return error for exe_document with invalid navigation object', () => {
            const parsed = {
                exe_document: {
                    meta: { title: 'Test' },
        ...
        it('should return error for exe_document with empty page array', () => {
            const parsed = {
                exe_document: {
                    meta: { title: 'Test' },
                    navigation: {
            ...
            const result = validateOdeXml(parsed);
            expect(result.valid).toBe(false);
            expect(result.errors.some(e => e.code === 'EMPTY_NAVIGATION')).toBe(true);
        });

        it('should return warning for exe_document without title in meta', () => {
            const parsed = {
                exe_document: {
        ...
        it('should return error for exe_document page with invalid object', () => {
            const parsed = {
                exe_document: {
                    meta: { title: 'Test' },
                    navigation: {
        ...
        it('should return error for exe_document page missing id attribute', () => {
            const parsed = {
                exe_document: {
                    meta: { title: 'Test' },
                    navigation: {
        ...
        it('should return error for exe_document page missing title attribute', () => {
            const parsed = {
                exe_document: {
                    meta: { title: 'Test' },
                    navigation: {
        ...
        it('should validate exe_document page with components', () => {
            const parsed = {
                exe_document: {
                    meta: { title: 'Test' },
                    navigation: {
        ...
        it('should return error for exe_document component missing type attribute', () => {
            const parsed = {
                exe_document: {
                    meta: { title: 'Test' },
                    navigation: {
        ...
        it('should return error for exe_document component missing id attribute', () => {
            const parsed = {
                exe_document: {
                    meta: { title: 'Test' },
                    navigation: {
        ...
        it('should return error for exe_document component with invalid object', () => {
            const parsed = {
                exe_document: {
                    meta: { title: 'Test' },
                    navigation: {
        ...
        it('should validate exe_document with nested pages', () => {
            const parsed = {
                exe_document: {
                    meta: { title: 'Test' },
                    navigation: {
        ...
        it('should validate exe_document with multiple components', () => {
            const parsed = {
                exe_document: {
                    meta: { title: 'Test' },
                    navigation: {
                        page: {
                            ...
                            '@_title': 'Home',
                            component: [
                                { '@_type': 'text', '@_id': 'comp1' },
                                { '@_type': 'quiz', '@_id': 'comp2' },
                            ],
                        },
                    },
                },
        ...
        it('should validate exe_document with multiple pages', () => {
            const parsed = {
                exe_document: {
                    meta: { title: 'Test' },
                    navigation: {
                        page: [
                            { '@_id': 'page1', '@_title': 'Page 1' },
                            { '@_id': 'page2', '@_title': 'Page 2' },
                        ],
                    },
                },
            };
        ...
        it('should return error for invalid ode object type (string)', () => {
            const parsed = {
                ode: 'not an object',
            };
            ...
            const result = validateOdeXml(parsed);
            expect(result.valid).toBe(false);
            expect(result.errors.some(e => e.code === 'INVALID_ODE')).toBe(true);
            expect(result.errors.some(e => e.message === 'ode is not a valid object')).toBe(true);
        });

        it('should return error for ode value being null (treated as missing root)', () => {
            const parsed = {
                ode: null,
            };
            ...
            const result = validateOdeXml(parsed);
            expect(result.valid).toBe(false);
            // null is falsy, so it's treated as missing root, not invalid ode
            expect(result.errors.some(e => e.code === 'MISSING_ROOT')).toBe(true);
        });

        it('should return error for invalid ode object type (number)', () => {
            const parsed = {
                ode: 123,
            };
