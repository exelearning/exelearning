...
export enum ExportFormat {
    ...
    SCORM_12 = 'scorm12',
    PAGE_SCORM_12 = 'pagescorm12',
    BLOCK_SCORM_12 = 'boxscorm12',
    IDEVICE_SCORM_12 = 'idevicescorm12',
...
> = {
    ...
    [ExportFormat.PAGE_SCORM_12]: {
        name: 'Page SCORM 1.2',
        extension: '.zip',
        suffix: '_page_scorm12',
        description: 'Single page SCORM 1.2 package for LMS',
    },
    [ExportFormat.BLOCK_SCORM_12]: {
        name: 'Box SCORM 1.2',
        extension: '.zip',
        suffix: '_box_scorm12',
        description: 'Single box SCORM 1.2 package for LMS',
    },
    [ExportFormat.IDEVICE_SCORM_12]: {
        name: 'iDevice SCORM 1.2',
        extension: '.zip',
        suffix: '_idevice_scorm12',
        description: 'Single iDevice SCORM 1.2 package for LMS',
    },
