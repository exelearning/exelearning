...
export class Scorm2004Exporter extends Html5Exporter {
    ...
    async export(options?: ExportOptions): Promise<ExportResult> {
        ...
        try {
            ...
            // Initialize generators with visible pages only
            this.manifestGenerator = new Scorm2004ManifestGenerator(projectId, visiblePages, {
    ...
    generateScorm2004PageHtml(
        ...
        return this.pageRenderer.render(page, {
            ...
            addSearchBox: false,
            // Force page counter for SCORM (count visible pages only)
            addPagination: true,
