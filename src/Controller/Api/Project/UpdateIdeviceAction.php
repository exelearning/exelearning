...
#[AsController]
#[Route('/api/v2/projects/{projectId}/pages/{pageId}/blocks/{blockId}/idevices/{ideviceId}', name: 'api_v2_projects_pages_blocks_idevices_update', methods: ['PATCH'])]
class UpdateIdeviceAction extends AbstractController
{
    ...
    public function __invoke(string $projectId, Request $request, string $ideviceId)
    {
        ...
        try {
            $saved = $this->service->setIdevice($projectId, $nodeId, $blockId, $ideviceId, $payload);
