...
class ExportSCORM12Service implements ExportServiceInterface
{
    private $exportType;
    ...
    public function __construct(
        ...
        $this->exportType = Constants::EXPORT_TYPE_SCORM12;
    ...
    private function generateExportXMLFiles(
        ...
        // ismanifest.xml
        $imsmanifest = ExportXmlUtil::createSCORM12imsmanifest(
            $odeId,
            $odeNavStructureSyncs,
            $pagesFileData,
            $odeProperties,
