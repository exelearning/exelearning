...
var $Lomloe = {
    ...
    getHTMLView: function (data, pathMedia) {
        ...
        // Per-dataset descriptor overrides denormalized by the editor on save
        // (e.g. Valencian text); consulted by the fallback renderer below.
        this._descriptors = data.lomloeDescriptors || {};
            ...
            compGroups.forEach(function (group) {
                ...
                group.items.forEach(function (sel) {
                    ...
                    (sel.competenciasClave || []).forEach(function (cc) {
                        var title = (self._descriptors && self._descriptors[cc]) || self.CC_DESCRIPTIONS[cc] || cc;
