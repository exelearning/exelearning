...
- **Primària**: criteris/sabers are defined per cicle and duplicated into the concrete years of each cycle. **ESO/Batxillerat**: per course; single-course subjects without an explicit course label in the annex are made browsable in every year of the stage (as in Navarra).
