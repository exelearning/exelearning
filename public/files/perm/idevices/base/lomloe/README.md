...
- **Descriptors operatius del perfil d'eixida (`competencias_clave`)**: present where the source publishes them (the ESO Connexions/secció 3 CE×key-competence matrix). Infantil, Primària and Batxillerat are added as the source exposes them.
