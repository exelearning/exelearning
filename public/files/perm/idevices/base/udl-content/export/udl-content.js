...
var $udlcontent = {
  ...
  init: function () {
    ...
    $(".exe-udlContent").each(function () {
      ...
      blocks.each(function (i) {
        ...
        // Add a Close link
        nav += '<li class="exe-udlContent-alt-toggler"><a href="#' + blockId + '-content-main" class="exe-udlContent-alt-lnk exe-udlContent-alt-lnk-close" title="' + $udlcontent.closeBtnTxt + '"><span class="sr-av">' + $udlcontent.closeBtnTxt + '</span></a></li>'
    ...
    $(".exe-udlContent-block-toggler a.udl-character").each(function () {
      ...
      if (c == 1 || c == 2 || c == 3 || c == 4) {
        ...
        if (img != "") {
          ...
          if (ext != ".gif") {
            img = $udlcontent.getBase() + "udl-character-" + c + ".gif";
          }
  ...
  getCloseAltLink: function (blockId, type, tit) {
    return '<p class="exe-udlContent-alt-close-lnk"><a href="#' + blockId + '-content-main" title="' + $udlcontent.closeBtnTxt + '" class="udl-lnk-' + type + '"><span>' + $udlcontent.closeBtnTxt + ' (' + tit + ')</span></a></p>';
  },
