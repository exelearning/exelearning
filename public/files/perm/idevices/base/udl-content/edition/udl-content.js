...
var $exeDevice = {
  ...
  addBlockEvents: function (i) {
    ...
    $("input[name='udlContentCharacter-" + i + "']").change(function () {
      ...
      $("#" + this.name + "-thumbnail").attr("src", $exeDevice.idevicePath + "characters/" + v + ".png").attr("title", imgNames[v]).attr("class", "pos-" + v);
    });
    // Delete block
				...
				<div class="udlContentFormBlockContent">\
					<p class="udlContentFormBlockButtonTxt udlContentField">\
						...
						<span class="udlContentFormBlockButtonTxtOptions"'+ btnOptionsStyle + '>\
							...
							<img src="'+ this.idevicePath + 'characters/' + btnType + '.png" alt="' + _('Character') + '" title="' + imgNames[btnType] + '" class="pos-' + btnType + '" />\
						</span>\
					</p>\
