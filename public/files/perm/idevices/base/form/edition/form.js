...
var $exeDevice = {
    ...
    loadPreviousValues: function () {
            ...
            previousData.questionsData.forEach((question) => {
                ...
                switch (question.activityType) {
                    case $exeDevice.questionsIds[0]: // dropdown.
                        htmlForm += form.getProcessTextDropdownQuestion(
                            question.baseText,
                    ...
                    case $exeDevice.questionsIds[1]: // selection
                        ...
                        htmlForm += form.getProcessTextSelectionQuestion(
                            question.baseText,
                            radioOrCheckbox,
                            question.answers
                        );
                    ...
                    case $exeDevice.questionsIds[2]: // true-false
                        htmlForm += form.getProcessTextTrueFalseQuestion(
                            question.baseText,
                            question.answer
                        );
                        htmlForm += `</div></li>`;
                    ...
                    case $exeDevice.questionsIds[3]: // fill
                        htmlForm += form.getProcessTextFillQuestion(
                            question.baseText,
        ...
        formPreview = $exeDevice.ideviceBody.querySelector(
            `#${$exeDevice.formPreviewId}`
        );
    ...
    setBehaviourFormView: function () {
        this.form.behaviourButtonsQuestionInFormViewAll(
     ...
     */
    getQuestionsData() {
        let htmlFormQuestions = this.ideviceBody.querySelector(
            `#${this.formPreviewId}`
        ).children;
        let formQuestions = [];
        ...
        [...htmlFormQuestions].forEach((htmlQuestion) => {
            if (
                htmlQuestion.getAttribute('activity-type') ===
                this.questionsIds[0]
            ) {
                let values = [];
                let htmlAnswers = htmlQuestion.querySelectorAll(
                    "[id^='dropdownAnswer_'"
                );
                ...
                let dropdownData = {
                    ...
                    baseText: htmlQuestion.querySelector(
                        "[id^='dropdownBaseText_'"
                    ).innerHTML,
                    wrongAnswersValue: htmlQuestion.querySelector(
                        "[id^='dropdownWrongAnswer_'"
                    ).textContent,
                };
                ...
                let inputs = htmlQuestion
                    .querySelector("[id^='SelectionQuestion_'")
                    .querySelectorAll('INPUT');
                let checkedOptions = htmlQuestion
                    .querySelector("[id^='SelectionAnswer_'")
                    .textContent.split(',');
                ...
                let html = htmlQuestion.querySelector(
                    "[id^='QuestionElement_'"
                ).innerHTML;
                let htmlOptions = htmlQuestion.querySelector(
                    "[id^='SelectionQuestion_'"
                ).outerHTML;
                ...
                let htmlOptions = htmlQuestion.querySelector(
                    "[id^='TrueFalseQuestion_'"
                ).outerHTML;
                let questionHtml = html.replace(htmlOptions, '');
                let trueFalseData = {
                    activityType: htmlQuestion.getAttribute('activity-type'),
                    baseText: questionHtml,
                    answer: htmlQuestion.querySelector(
                        "[id^='TrueFalseAnswer_'"
                    ).textContent,
                };
                ...
                let fillData = {
                    activityType: htmlQuestion.getAttribute('activity-type'),
                    baseText: htmlQuestion.querySelector("[id^='fillBaseText_'")
                        .innerHTML,
                    capitalization: htmlQuestion.querySelector(
                        "[id^='fillCapitalization_'"
                    ).textContent,
                    strict: htmlQuestion.querySelector(
                        "[id^='fillStrictQualification_'"
                    ).textContent,
                };
    ...
    Form: class {
        ...
        setBehaviour() {
            ...
            this.behaviourButtonHideShowQuestions(
                $exeDevice.btnQuestionsBottom
            );
            this.behaviourButtonAddTrueFalseQuestion(
        ...
        behaviourButtonHideShowQuestions(selectorId) {
            const button = $exeDevice.ideviceBody.querySelector(
                `#${selectorId}`
            );
        ...
        hideQuestionsPanel(id) {
            $exeDevice.ideviceBody.querySelector(`#${id}`).style.display =
                'none';
        }
        ...
        behaviourButtonAddTrueFalseQuestion(selectorId, relativePosition) {
            ...
            $exeDevice.ideviceBody
                ...
                .addEventListener('click', function () {
                    ...
                    form.showQuestionInstructions(
                        questionTitleContainer,
                        form.strings.msgInstructionsQuestion
                    );
        ...
        behaviourButtonAddSelectionQuestion(selectorId, relativePosition) {
            ...
            $exeDevice.ideviceBody
                ...
                .addEventListener('click', function () {
                    ...
                    form.behaviourToggleOneMultipleAnswer(
                        'buttonRadioCheckboxToggle'
                    );
                    form.behaviourButtonAddOption(
                    ...
                    form.showQuestionInstructions(
                        questionTitleContainer,
                        form.strings.msgInstructionsSelection
                    );
        ...
        behaviourButtonAddOption(selectorId) {
            ...
            ideviceBody
                ...
                .addEventListener('click', function () {
                    let optionCount =
                        ideviceBody.querySelectorAll(`INPUT[id^=option_]`)
                            .length + 1;
                ...
                ${form.createTextArea(`${$exeDevice.formPreviewId}Textarea_${randomId}`, 'small-textarea')}`;
                    ...
                    form.behaviourButtonRemoveOption(
        ...
        behaviourButtonAddFillQuestion(selectorId, relativePosition) {
            ...
            button.addEventListener('click', function () {
                ...
                form.showQuestionInstructions(
                    questionTitleContainer,
                    form.strings.msgInstructionsFill
                );
                ...
                form.showQuestionInstructions(
                    capitalization,
                    form.strings.msgInstructionsFillCapitalization
                );
                ...
                form.showQuestionInstructions(
                    strictQualification,
                    form.strings.msgInstructionsFillStrictQualification
                );
        ...
        behaviourButtonAddDropdownQuestion(selectorId, relativePosition) {
            ...
            $exeDevice.ideviceBody
                ...
                .addEventListener('click', function () {
                    ...
                    form.showQuestionInstructions(
                        questionTitleContainer,
                        form.strings.msgInstructionsDropdown
                    );
                    ...
                    form.showQuestionInstructions(
                        otherWords,
                        form.strings.msgInstructionsDropdownOtherWords
                    );
                    $exeDevice.ideviceBody.querySelector(
                        `#${$exeDevice.msgNoQuestionsId}`
                    ).style.display = 'none';
        ...
        behaviourButtonRemoveQuestion() {
            const form = new $exeDevice.Form($exeDevice, $exeDevice.questions);
            $exeDevice.ideviceBody
                .querySelector('#removeQuestionContainer')
                .addEventListener('click', () => {
                    eXe.app.confirm(
                        _('Attention'),
                        form.strings.msgConfirmRemoveQuestion,
                        () => {
        ...
        behaviourButtonCancelQuestion() {
            const form = new $exeDevice.Form($exeDevice, $exeDevice.questions);
            $exeDevice.ideviceBody
                .querySelector('#cancelQuestionContainer')
                .addEventListener('click', () => {
                    eXe.app.confirm(
                        _('Attention'),
                        form.strings.msgConfirmCancelEdit,
                        () => {
        ...
        addQuestionfrmorm(containerId, questionType) {
            ...
            questionElement.classList.add(
                `FormViewContainer_${questionType}`,
                'FormViewContainer'
            );
            questionElement.innerHTML = this.generateElementQuestionForm(
                containerId,
                questionType
            );
            ...
            const buttons = [
                {
                    class: 'QuestionLabel_moveUp',
                    text: 'arrow_upward',
                    action: 'behaviourButtonMoveUpQuestionInFormView',
                },
                {
                    class: 'QuestionLabel_moveDown',
                    text: 'arrow_downward',
                    action: 'behaviourButtonMoveDownQuestionInFormView',
                },
                {
                    class: 'QuestionLabel_edit',
                    text: 'edit',
                    action: 'behaviourButtonEditQuestionInFormView',
                },
                {
                    class: 'QuestionLabel_remove',
                    text: 'close',
                    action: 'behaviourButtonCloseQuestionInFormView',
                },
            ];
            ...
            buttonsContainer.classList.add(
                'inline',
                'QuestionLabel_ButtonsContainer'
            );
            ...
            elementQuestionContainer.classList.add(
                `FormView_${questionType}`,
                'FormView_question'
            );
            elementQuestionContainer.dataset.id = formIdElement;
            elementQuestionContainer.setAttribute(
                'activity-type',
                questionType
            );
            if (questionType === 'selection')
            ...
            const inEditionQuestion = $exeDevice.ideviceBody
                .querySelector('#saveQuestion')
                .closest('LI');
        ...
        generateElementQuestionForm(containerId, questionId) {
            ...
            let valueInputText = ``;
            let valueAnswer = ``;
            let container = $exeDevice.ideviceBody.querySelector(
                `#${containerId}`
            );
            ...
            switch (questionId) {
                case 'dropdown':
                    valueText =
                        this.parent.getEditorTinyMCEValue(tinyTextareaId);
        ...
        createQuestionTextareaFieldset(
            ...
            if (buttonShowHide)
                html += this.showHideWordButton(`${id}Textarea`);
            if (radioTrueFalse)
        ...
        getHtmlFormQuestionFill(visible) {
            ...
            html += this.createQuestionTextareaFieldset(
                'fillQuestionTextarea_0',
                this.strings.msgEText,
                true,
                false
            );
            html += `</div>`;
        ...
        behaviourEvaluation() {
            ...
            const evaluationHelpLink =
                ideviceBody.querySelector('#helpLinkButton');
            const evaluationInput =
                ideviceBody.querySelector('#evaluationIDInput');
                ...
                if (question.nextElementSibling) {
                    if (
                        question.nextElementSibling.querySelector(
                            '#formPreviewTextareaContainer'
                        ) !== null &&
                        question.nextElementSibling.nextElementSibling !== null
                    ) {
                        question.nextElementSibling.nextElementSibling.after(
                            question
                        );
                    } else {
        ...
        behaviourButtonMoveUpQuestionInFormView(element) {
            ...
            element.addEventListener('click', function (event) {
                ...
                if (question.previousElementSibling) {
                    if (
                        question.previousElementSibling.style.display === 'none'
                    ) {
                        question.previousElementSibling.previousElementSibling.before(
                            question
                        );
                    } else {
        ...
        setDataFromTrueFalseQuestion(question) {
            ...
            let questionText = '';
            let checkedOption = bodyQuestion.querySelector(
                'span[id^="TrueFalseAnswer"]'
            ).innerHTML;
            ...
            newTextarea.innerHTML = questionText.replace(
                /<p>\s*(<br\s*\/?>)?\s*<\/p>/gi,
                ''
            );
        ...
        setDataFromSelectionQuestion(question) {
            ...
            questionTextarea.innerHTML = questionText.replace(
                /<p>\s*(<br\s*\/?>)?\s*<\/p>/gi,
                ''
            );

            let bodyOptions = bodyQuestion.querySelector(
                'DIV[id^=SelectionQuestion]'
            );
            ...
            let optionsTextareas = $exeDevice.ideviceBody.querySelectorAll(
                `TEXTAREA[id^=${$exeDevice.formPreviewId}]`
            );

            let checkedOptions = bodyQuestion.querySelector(
                'span[id^="SelectionAnswer"]'
            ).innerHTML;
            ...
            Object.entries(options).forEach(([key, valuePreview]) => {
                if (key !== (options.length - 1).toString()) {
                    ...
                    optionsTextareas[parseInt(key) + 1].value =
                        valuePreview.querySelector('LABEL').textContent;

                    if (checkedOptions.includes(key)) {
                        $exeDevice.ideviceBody
                            .querySelector(
                                `#option_${parseInt(key) + 1}_container`
                            )
        ...
        setDataFromFillQuestion(question) {
            const bodyQuestion = question.querySelector(
                '[id^="QuestionElement"]'
            );
            if (!bodyQuestion) {
                console.error(
                    'No element with an id starting with "QuestionElement" was found.'
                );
                return;
            }
            ...
            const capSpan = bodyQuestion.querySelector(
                'span[id^="fillCapitalization"]'
            );
            const strictSpan = bodyQuestion.querySelector(
                'span[id^="fillStrictQualification"]'
            );

            const checkCapitalization = capSpan ? capSpan.innerHTML.trim() : '';
            const strictQualification = strictSpan
                ? strictSpan.innerHTML.trim()
                : '';
            ...
            if (textarea) {
                textarea.value = questionHTML.replace(
                    /<p>\s*(<br\s*\/?>)?\s*<\/p>/gi,
                    ''
                );
            } else {
                console.warn(
                    `No <textarea> with an id starting with "${$exeDevice.formPreviewId}" was found.`
                );
            }
            ...
            if (capInput) {
                ...
                console.warn(
                    `No <input> with the id "#checkCapitalization_${$exeDevice.formPreviewId}" was found.`
                );
            }
            ...
            if (strictInput) {
                ...
                console.warn(
                    `No <input> with the id "checkStrictQualification_${$exeDevice.formPreviewId}S" was found.`
                );
            }
        }
        ...
        setDataFromDropdownQuestion(question) {
            ...
            if (!bodyQuestion) {
                console.error(
                    'No element with an id that starts with "QuestionElement" was found.'
                );
                return;
            }
            ...
            clone
                .querySelectorAll('span[id^="dropdownAnswer"]')
                .forEach((span) => {
                    const u = document.createElement('u');
                    u.innerHTML = span.innerHTML;
                    span.replaceWith(u);
            ...
            const questionHTML = clone.innerHTML;
            const wrongSpan = bodyQuestion.querySelector(
                'span[id^="dropdownWrongAnswer"]'
            );
            ...
            if (otherInput) {
                ...
                console.warn(
                    `No <input> with the id "${$exeDevice.formPreviewId}InputText" was found.`
                );
            }
        }
        ...
        getProcessTextDropdownQuestion(baseText, otherWordsText) {
            ...
            let $dropdownWrongAnswer = $wrapper.find(
                'span.dropdownWrongAnswer'
            );
            let wrongAnswer = '';
            ...
            if (!htmlDropdown.includes('dropdownBaseText')) {
                ...
                let oldBaseText =
                    /<div id="dropdownBaseText[^>]*>[\s\S]*?<\/div>/;
        ...
        getProcessTextFillQuestion(
            ...
            if (!htmlFill.includes('fillCapitalization')) {
                ...
                let oldCap =
                    /<span id="fillCapitalization[^>]*>[\s\S]*?<\/span>/;
        ...
        disableArrowUpDown() {
            ...
            Object.entries(questions).forEach(([index, question]) => {
                if (index == 0) {
                    // Disable up arrow
                    if (
                        question.querySelector('.QuestionLabel_moveUp') !== null
                    ) {
                        question
                            .querySelector('.QuestionLabel_moveUp')
