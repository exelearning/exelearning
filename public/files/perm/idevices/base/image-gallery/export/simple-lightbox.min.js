                            ...
                            _createClass(SimpleLightbox, [
                                                ...
                                                if (
                                                    ...
                                                    if (
                                                        ...
                                                        if (
                                                            ...
                                                            _this5.options.captionsData.forEach(
                                                                (dataKey) => {
                                                                    if (
                                            ...
                                            this.addEventListener(
                                                ...
                                                function (event) {
                                                    ...
                                                    _this6.controlCoordinates.pinchOffsetY =
                                                        event.pageY -
                                                            scrollTopPos || 0; // need to substract the scroll position
                                    ...
                                    value: function setCaption(
                                        ...
                                        if (
                                            ...
                                            this.domNodes.caption.style.width =
                                                imageWidth + 'px';
                                            // +++++ SDWEB +++++
                                            // let captionArray = null;
                                            let newCaptionText = '';
                                            if (captionText.includes('|+|')) {
                                                // Add author data
                                                if (
                                                    _this7.options.myCaptionData
                                                        .author !== '' &&
                                                    _this7.options.myCaptionData
                                                        .authorlink === ''
                                                ) {
                                                    newCaptionText += `<span class="caption autor">${_this7.options.myCaptionData.author}</span>`;
                                                } else if (
                                                    _this7.options.myCaptionData
                                                        .author !== '' &&
                                                    _this7.options.myCaptionData
                                                    ...
                                                    newCaptionText += `<a href="${_this7.options.myCaptionData.authorlink}" target="_blank" class="caption author" rel="noopener">${_this7.options.myCaptionData.author}</a>`;
                                                } else if (
                                                    _this7.options.myCaptionData
                                                        .author === '' &&
                                                    _this7.options.myCaptionData
                                                    ...
                                                    newCaptionText += `<a href="${_this7.options.myCaptionData.authorlink}" target="_blank" class="caption author" rel="noopener">${_this7.options.myCaptionData.authorlink}</a>`;
                                                }
                                                ...
                                                if (
                                                    ...
                                                    newCaptionText += `<span class="caption title"><em>${_this7.options.myCaptionData.title}</em></span>`;
                                                } else if (
                                                    _this7.options.myCaptionData
                                                        .title !== '' &&
                                                    _this7.options.myCaptionData
                                                    ...
                                                    newCaptionText += `<a href="${_this7.options.myCaptionData.titlelink}" target="_blank" class="caption title" rel="noopener"><em>${_this7.options.myCaptionData.title}</em></a>`;
                                                } else if (
                                                    _this7.options.myCaptionData
                                                        .title === '' &&
                                                    _this7.options.myCaptionData
                                                    ...
                                                    newCaptionText += `<a href="${_this7.options.myCaptionData.titlelink}" target="_blank" class="caption title" rel="noopener"><em>${_this7.options.myCaptionData.titlelink}</em></a>`;
                                                }

                                                // Add license data
                                                let licenseTextIndication = '';
                                                let surroundOpen = '(';
                                                let surroundClose = ')';
                                                if (
                                                    _this7.options.myCaptionData
                                                ...
                                                if (
                                                    ...
                                                    newCaptionText += `<span class="caption license">${licenseTextIndication}${surroundOpen}<span class="custom-license">${_this7.options.myCaptionData.license}</span>${surroundClose}</span>`;
                                                } else if (
                                                    _this7.options.myCaptionData
                                                        .license !== '' &&
                                                    _this7.options.myCaptionData
                                                    ...
                                                    newCaptionText += `<span class="caption license">${licenseTextIndication}${surroundOpen}<a href="${_this7.options.myCaptionData.licenselink}" rel="license nofollow noopener" target="_blank" title="${_this7.options.myCaptionData.license}">${_this7.options.myCaptionData.license}</a>${surroundClose}</span>`;
                                                }

                                                this.domNodes.caption.innerHTML =
                                                    newCaptionText;
                                            } else {
                                                this.domNodes.caption.innerHTML =
                                                    captionText;
                                ...
                                },
                                {
                                    ...
                                    value: function openImage(element) {
                                        ...
                                        this.relatedElements = this.getRelated(
                                            element.rel
                                        );
