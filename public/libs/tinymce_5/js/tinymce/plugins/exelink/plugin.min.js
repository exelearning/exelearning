        ...
        if (showFileInfo) {
            ...
            var xhr = jQuery.ajax({
                ...
                success: function(res){
                    ...
                    if (size!=0) {
                        api.setData({
                            fileInfoSize:size.toString()
                        });
                        let inputSize = $("#inputFileSize");
                        tinymce.DOM.setAttribs(inputSize, { 'original-size': size.toString() + ' B' });
                    }
                },
                error: function(){
            ...
            onChange: function (api, _a) {
                ...
                // data files
                    ...
                    if (size !== undefined) {
                        ...
                        api.setData({ fileInfoSize: "", fileInfoUnit: "B" });
                        ...
                        if (currentUrl && currentUrl.trim() !== '') {
                            jQuery.ajax({
                                ...
                                url: currentUrl,
                                success: function (res) {
                                    var fetchedSize = res.length;
                                    if (fetchedSize != 0) {
                                        api.setData({ fileInfoSize: fetchedSize.toString() });
                                        let inputSize = $("#inputFileSize");
                                        tinymce.DOM.setAttribs(inputSize, { 'original-size': fetchedSize.toString() + ' B' });
                                    }
                                },
                                error: function () {
                                    api.setData({ fileInfoSize: "" });
