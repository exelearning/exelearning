      ...
      return {
        ...
        onAction: function (api, details) {
          if (details.name == 'imageOptimizer') {
            ...
            var basePath = top.eXeLearning && top.eXeLearning.config && top.eXeLearning.config.basePath
              ? top.eXeLearning.config.basePath.replace(/\/+$/, '')
              : '';
            var version = top.eXeLearning && top.eXeLearning.version ? top.eXeLearning.version : '';
            var optimizerUrl = (basePath ? basePath : '') +
              (version ? '/' + version : '') +
