/*
    eXeLearning changes (i18n only):
        invalid data URI → Please enter a valid URL.
        The first argument must be an image File or Blob object. → Please select an image.
        The first argument must be a File or Blob object. → Please select an image.
*/
/*!
