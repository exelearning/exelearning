var ProseMirrorBundle = (() => {
  ...
  function run(view, from2, to, text, rules, plugin) {
    ...
    for (let i = 0; i < rules.length; i++) {
      ...
      if (!match2 || match2[0].length < text.length)
        continue;
      let startPos = from2 - (match2[0].length - text.length);
      if (!rule.inCodeMark) {
        let hasMark = false;
  ...
  var CellSelection = class CellSelection2 extends Selection {
    ...
    static colSelection($anchorCell, $headCell = $anchorCell) {
      ...
      if (anchorRect.top <= headRect.top) {
        if (anchorRect.top > 0) $anchorCell = doc4.resolve(tableStart + map2.map[anchorRect.left]);
        if (headRect.bottom < map2.height) $headCell = doc4.resolve(tableStart + map2.map[map2.width * (map2.height - 1) + headRect.right - 1]);
      } else {
        if (headRect.top > 0) $headCell = doc4.resolve(tableStart + map2.map[headRect.left]);
        if (anchorRect.bottom < map2.height) $anchorCell = doc4.resolve(tableStart + map2.map[map2.width * (map2.height - 1) + anchorRect.right - 1]);
      }
    ...
    static rowSelection($anchorCell, $headCell = $anchorCell) {
      ...
      if (anchorRect.left <= headRect.left) {
        if (anchorRect.left > 0) $anchorCell = doc4.resolve(tableStart + map2.map[anchorRect.top * map2.width]);
        if (headRect.right < map2.width) $headCell = doc4.resolve(tableStart + map2.map[map2.width * (headRect.top + 1) - 1]);
      } else {
        if (headRect.left > 0) $headCell = doc4.resolve(tableStart + map2.map[headRect.top * map2.width]);
        if (anchorRect.right < map2.width) $anchorCell = doc4.resolve(tableStart + map2.map[map2.width * (anchorRect.top + 1) - 1]);
      }
      return new CellSelection2($anchorCell, $headCell);
    }
    toJSON() {
  ...
  var $Custom = class extends Schema2 {
    /**
  ...
  var $Literal = class extends Schema2 {
    /**
  ...
  var $StringTemplate = class extends Schema2 {
    /**
     * @param {T} shape
     */
    constructor(shape) {
  ...
  var $Optional = class extends Schema2 {
    /**
     * @param {S} shape
     */
    constructor(shape) {
  ...
  var $Never = class extends Schema2 {
    /**
     * @param {any} _o
     * @param {ValidationError} [err]
     * @return {_o is never}
  ...
  var $Object = class _$Object extends Schema2 {
    /**
     * @param {S} shape
  ...
  var $Record = class extends Schema2 {
    /**
     * @param {Keys} keys
     * @param {Values} values
     */
  ...
  var $Tuple = class extends Schema2 {
    /**
     * @param {S} shape
     */
    constructor(shape) {
  ...
  var $Array = class extends Schema2 {
    /**
     * @param {Array<S>} v
     */
    constructor(v) {
  ...
  var $InstanceOf = class extends Schema2 {
    /**
  ...
  var $$schema = $instanceOf(Schema2);
  var $Lambda = class extends Schema2 {
    /**
     * @param {Args} args
     */
    constructor(args2) {
  ...
  var $Intersection = class extends Schema2 {
    /**
     * @param {T} v
     */
    constructor(v) {
  ...
  var $Union = class extends Schema2 {
    static _dilutes = true;
    /**
  ...
  var assert = production ? () => {
    ...
    if (!schema2.check(o, err)) {
      throw create2(`Expected value to be of type ${schema2.constructor.name}.
${err.toString()}`);
    }
  };
  ...
  var createTextNodesFromYText = (text, schema2, _meta, snapshot2, prevSnapshot, computeYChange) => {
    const nodes2 = [];
  ...
  var equalAttrs = (pattrs, yattrs) => {
    ...
    for (let i = 0; i < keys3.length && eq; i++) {
      ...
      const l = pattrs[key];
      const r = yattrs[key];
      eq = key === "ychange" || l === r || isObject2(l) && isObject2(r) && equalAttrs(l, r);
    }
    return eq;
  };
  ...
  function prosemirrorJSONToYDoc(schema2, state, xmlFragment = "prosemirror") {
    const doc4 = Node.fromJSON(schema2, state);
    return prosemirrorToYDoc(doc4, xmlFragment);
  }
  function prosemirrorJSONToYXmlFragment(schema2, state, xmlFragment) {
    const doc4 = Node.fromJSON(schema2, state);
    return prosemirrorToYXmlFragment(doc4, xmlFragment);
  }
  function yDocToProsemirror(schema2, ydoc) {
    const state = yDocToProsemirrorJSON(ydoc);
    return Node.fromJSON(schema2, state);
  }
