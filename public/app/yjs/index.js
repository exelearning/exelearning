...
window.YjsModules = {
  ...
  // Note: collaborative rich-text editors (the collaborative-editing iDevice)
  // bind to Yjs directly via window.YjsProseMirrorBinding using a top-level
  // Y.XmlFragment keyed by `${componentId}-${fieldName}`. See
