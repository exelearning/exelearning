  ...
  beforeEach(() => {
    ...
    mockElement.innerHTML = `
      ...
      <div class="modal-body">
        ...
        <div class="media-library-usage-row"><span class="media-library-usage"></span></div>
        ...
        <input type="file" class="media-library-replace-input">
        <a class="media-library-replace-btn" href="#"></a>
