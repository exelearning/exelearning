...
import ModalDownloadPage from './modals/pages/modalDownloadPage.js';
...
export default class ModalsManagement {
    ...
    init() {
        ...
        this.pagedownload = new ModalDownloadPage(this);
    }
