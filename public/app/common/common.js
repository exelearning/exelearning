...
window.MathJax = window.MathJax || (function() {
    ...
    return {
        tex: {
            ...
            packages: {
                '[+]': ['ams', 'amscd', 'bbox', 'boldsymbol', 'braket', 'bussproofs',
                    ...
                    'mhchem', 'newcommand', 'noerrors', 'noundefined', 'physics',
        ...
        loader: {
            ...
            load: ['[tex]/ams', '[tex]/amscd', '[tex]/bbox', '[tex]/boldsymbol',
                '[tex]/braket', '[tex]/bussproofs', '[tex]/cancel', '[tex]/cases',
                '[tex]/centernot', '[tex]/color', '[tex]/colortbl', '[tex]/configmacros',
                '[tex]/empheq', '[tex]/enclose', '[tex]/extpfeil', '[tex]/gensymb',
                '[tex]/html', '[tex]/mathtools', '[tex]/mhchem', '[tex]/newcommand',
                '[tex]/noerrors', '[tex]/noundefined', '[tex]/physics', '[tex]/textcomp',
                '[tex]/textmacros', '[tex]/unicode', '[tex]/upgreek', '[tex]/verb'
            ]
        },
        textmacros: {
            packages: { '[+]': ['textcomp', 'bbox'] }
        }
    };
})();
