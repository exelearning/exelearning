...
function initializeEnv() {
    ...
    customEnv = {
        ...
        FILES_DIR: process.env.FILES_DIR?.trim() || path.join(appDataPath, 'data'),
        CACHE_DIR: process.env.CACHE_DIR?.trim() || path.join(appDataPath, 'cache'),
        LOG_DIR: process.env.LOG_DIR?.trim() || path.join(appDataPath, 'log'),
