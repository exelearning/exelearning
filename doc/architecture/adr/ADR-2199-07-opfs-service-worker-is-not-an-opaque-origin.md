...
# ADR-2199-07: OPFS plus a Service Worker does not create an opaque origin (static/PWA limit)

## Context

The hybrid trust boundary (ADR-2199-02) can serve an opaque preview snapshot in
...
see [ADR-2199-05](ADR-2199-05-render-editor-preview-in-an-opaque-origin-sandbox.md)).
...
PHP-WASM builds therefore fall to ADR-2199-02's `consented-same-origin` row: when a
...
- [ADR-2199-02](ADR-2199-02-hybrid-preview-trust-boundary.md), [ADR-2199-05](ADR-2199-05-render-editor-preview-in-an-opaque-origin-sandbox.md)
