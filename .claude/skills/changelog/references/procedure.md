...
If the request does not already specify a mode, ask the user:
...
### A.1 Establish the last incorporated PR

Use the PR supplied in the request, or ask if it is missing:
