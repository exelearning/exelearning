...
class CurrentOdeUsersTest extends WebTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // Crear datos de prueba para CurrentOdeUsers
        ...
        // ... set other required fields based on your entity
        $em->persist($odeUser);
    ...
    {
        // User normal puede acceder
        $clientUser = static::createClient();
        $this->login($clientUser, $this->userEmail, $this->userPassword);
        
        $clientUser->request('GET', '/api/v2/current_ode_users/by_component/'.$this->testComponentId, 
    ...
    public function testUserNotFound(): void
    {
        ...
        $clientUser->request('GET', '/api/v2/current_ode_users/by_component/non-existent-id',
            server: [ 'HTTP_ACCEPT' => 'application/json' ]
        );
    ...
    public function testAdminCanAccess(): void
    {
        ...
        $clientAdmin->request('GET', '/api/v2/current_ode_users/by_component/'.$this->testComponentId,
            server: [ 'HTTP_ACCEPT' => 'application/json' ]
        );
    ...
    public function testAccessDeniedWithoutAuth(): void
    {
        ...
        $client->request('GET', '/api/v2/current_ode_users/by_component/'.$this->testComponentId,
            server: [ 'HTTP_ACCEPT' => 'application/json' ]
        );
